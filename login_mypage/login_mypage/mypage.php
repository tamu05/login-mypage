...
if(!empty($_SETTION['id']) && !empty($_SESSION['login_keep'])){
    setcookie('mail',SETTION['mail'],time()+60*60*24*7);
    setcookie('password',SETTION['password'],time()+60*60*24*7);
    setcookie('login_keep',SETTION['login_keep'],time()+60*60*24*7);
